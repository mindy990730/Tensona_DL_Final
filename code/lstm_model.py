...
class lstm_source(tf.keras.Model):
    def __init__(self, params):
        ...
        # self.dense_1 = tf.keras.layers.Dense(hidden_sz)
        self.dense_2 = tf.keras.layers.Dense(params.embed_size)
...
class lstm_target(tf.keras.Model):
    ...
    def call(self, encoded_input, initial_state, word_embedding, speaker, addressee):
        ...
        :param encoded_input: output of lstm_source, shape = (batch_size, sentence_max_length, embed_size)
        ...
        # print('concatenated word+speaker size = ', lstm_t_input)
